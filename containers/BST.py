...
ably harder than the functions in the BinaryTree file.
'''
...
class BST(BinaryTree):
    ...
    That means that the BST class "inh
    erits" all of the methods from BinaryTree,
    ...
    def __repr__(self):
        ...
        Recall that the __repr__ function should return a s
        tring that can be used to recreate a valid instance of the cl
        ass.
    ...
    def is_bst_satisfied(self):
        ...
        the first thing to do is to impl
        ement a function that checks whether
    ...
    def _is_bst_satisfied(node):
        ...
        it only checks if the children of the c
        urrent node are less than/greater than,
        rather than ensuring that all nodes to t
        he left/right are less than/greater than.

        HINT:
        Use the _find_smallest and _find_large
        st functions to fix the bug.
        You should use the _ prefixed methods beca
        use those are static methods just like this one.
        '''
        ret = True
        if node.left:
    ...
    def insert(self, value):
        ...
        HINT:
        Create a staticmethod helper function follo
        wing the pattern of _is_bst_satisfied.
        '''
    ...
    def insert_list(self, xs):
        ...
        You cannot get this method to work corr
        ectly until you have gotten insert to work correctly.
        '''
    ...
    def _find_smallest(node):
        '''
        This is a helper function for find_sm
        allest and not intended to be called directly by the user.
        '''
    ...
    def remove(self, value):
        ...
        HINT:
        You should have everything else wor
        king before you implement this function.
